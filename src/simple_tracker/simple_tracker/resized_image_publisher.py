...
class ResizedImagePublisherNode(Node):
  ...
  def __init__(self, configuration_client):
    ...
    self.camera_uri = response.value #SettingConvertor.Convert(response.type, response.value)
    ...
    self.resize_dimension = response.value #SettingConvertor.Convert(response.type, response.value)
    ...
    self.resize_frame = response.value #SettingConvertor.Convert(response.type, response.value)
